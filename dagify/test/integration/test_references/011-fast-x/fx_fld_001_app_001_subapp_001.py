...
with DAG(
    ...
    # DAG Tasks
    fx_fld_001_app_001_subapp_001_job_001 = SSHOperator(
      task_id="fx_fld_001_app_001_subapp_001_job_001",
      command="",
      dag=dag,
    )

    fx_fld_001_app_001_subapp_001_job_002 = SSHOperator(
      task_id="fx_fld_001_app_001_subapp_001_job_002",
      command="",
      dag=dag,
    )

    fx_fld_001_app_001_subapp_001_job_003 = SSHOperator(
    ...
    fx_fld_001_app_001_subapp_001_job_001 = ExternalTaskMarker(
        task_id="fx_fld_001_app_001_subapp_001_job_001",
